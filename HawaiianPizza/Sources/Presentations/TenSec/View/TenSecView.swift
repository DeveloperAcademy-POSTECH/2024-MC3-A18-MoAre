    ...
    var body: some View {
        NavigationStack(path: $coordinator.path) {
            VStack {
                ...
                Button(action: {
                    print("바로 시작 버튼 클릭됨")
                    print("현재 루틴: \(String(describing: timerManager.routine))")
                    timerManager.handleButtonPress()
